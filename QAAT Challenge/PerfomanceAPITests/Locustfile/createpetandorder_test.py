...
class CreatePetAndOrderTest(HttpUser):
    ...
    def delete_order(self):
        order_id = 100  # Cambia esto al ID del pedido que creaste en la tarea anterior
        self.client.delete(f"/v3/store/order/{order_id}")
